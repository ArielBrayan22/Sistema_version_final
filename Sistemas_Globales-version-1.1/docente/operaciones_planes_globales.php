...
<article id="cuerpo">
  ...
  <table id="tabla_Materias_Principal"><tr><td><form method="post" action="obciones_docente.php">
   <input type="submit" name="btn_Materias" value="Materias"></form>
  </td></tr></table>
 ...
 //MOSTRAR SELECCION Y ORGANIZACION DE CONTENIDOS
      ...
      // BOTON EDITAR MATERIA
       ...
       if(isset($_POST['btn_Editar_Materia'])){
        ...
        <table id='tabla_Identificacion'><tr><td colspan='2'>
        <center><h4> DATOS DE IDENTIFICACION </h4></center></td></tr>";
        while ($row=mysql_fetch_array($resultado)) {
       ...
       if(isset($_POST['btn_Justificacion']))
       {
          $Cod_Materia=$_POST['txt_Cod_M'];
          $Cod_PG=$_POST['txt_Cod_PG'];       
        echo "<center><table id='tabla_justificacion'>
        <tr><td><center><h4> JUSTIFICACION </h4></center></td></tr>";
        echo "<form method='post'>
        ...
        placeholder='Ingresar nueva Justificaccion'></textarea></td></tr>
        <tr><td><center>
        ...
        while ($row=mysql_fetch_array($resultado)) {
              ...
              echo "<form method='post' action=''>
               <input type='text' name='ID_PG' style='visibility:hidden' value='".$Cod_PG."'>
               <input type='text' name='txt_Cod_M' style='visibility:hidden' value='".$Cod_Materia."'>
              <tr><td><textarea name='txt_justificacion' cols='120' rows='15' >".$row['Justificacion'].
              "</textarea></td></tr>
             ...
             echo "<form method='post'>
                   ...
                   value='".$Cod_Materia."'>
                   <input type='text' name='ID_PG' style='visibility:hidden'
                   value='".$Cod_PG."'>
   ...
   //BOTON PARA CREAR UN NUEVA JUSTIFICACION 
      ...
      { 
       ...
       if(isset($_POST['btn_Objetivos'])){
        ...
        echo "<table id='tabla_Objetivo'><tr><td colspan='3'><center>OBJETIVOS</center></td></tr>";

        echo "<form method='post'>
   
              <tr><td><textarea cols='100' rows='3' name='txt_new_Objetivo'></textarea></td>
              <td>
              <input type='text' name='txt_Cod_M'  value='"
               .$Cod_Materia."'>

               <input type='text' name='ID_PG'  value='".$ID_PG."'></td></tr>
        ...
        while ($row=mysql_fetch_array($resultado)) {
            ...
            echo "<form method='post' action=''>
                  <input type='text' name='ID_PG' style='visibility:hidden' value='"
                  .$ID_PG."'>

                  <input type='text' name='txt_Cod_M' style='visibility:hidden' value='"
                  .$Cod_Materia."'>

                  <input type='text' style='visibility:hidden' value='".$row['ID_Objetivos']."' name='txt_Cod_O'></td></tr>
             ...
             echo "
                   ...
                   <tr><td><input type='submit' value='Siguiente' name='btn_Contenidos'>
                   </form></td></tr></table>";
         }
