...
<article id="cuerpo">
   ...
   <center><input type="submit" class="button_seleccion" name="btn_Materias" value="Seleccion de Materias"></center>
 
   
   </form>
    <center><img src="/Sistemas_Globales-version-1.1/imagenes/slider4.jpg" width="80%" height="60%"></center>
