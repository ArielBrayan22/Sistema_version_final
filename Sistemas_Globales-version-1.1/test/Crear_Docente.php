...
class Nuevo extends PHPUnit_Framework_TestCase
{
    ...
    public function testgetMenu_Admin()
    {
     ...
     public function testgetMenu_Admin_Impresion()
    {
      return $this->Plan_Global;
    }

     public function testgetMenu_Admin_Usuarios()
    {
      return $this->Plan_Global;
    }

     public function testgetMenu_Admin_Crer_Plan_Global()
    {
      return $this->Plan_Global;
    }

    public function testgetMenu_Admin_Password()
    {
      return $this->Plan_Global;
    }

     public function testgetMenu_Admin_User_List()
    {
      return $this->Plan_Global;
    }

     public function testgetMenu_Admin_Crer_Impresion_Plan_Global()
    {
      return $this->Plan_Global;
    }
